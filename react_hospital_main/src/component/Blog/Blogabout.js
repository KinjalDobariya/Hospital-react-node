                        ...
                        <div className="row">
                            <div className="col-lg-8 col-md-12 left-box">
                                <div className="card single_post" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                    <div className="body">
                                        <h3 className="m-t-0 m-b-5"><a href="blog-detail.html">All photographs are accurate. None of
                                    ...
                                    <div className="body">
                                        ...
                                        <a href="blog-detail.html" title="read more" className="btn btn-round btn-info">Read
                                            More</a>
                                    </div>
                                </div>
                                <div className="card single_post" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                    <div className="body">
                                        <h3 className="m-t-0 m-b-5"><a href="blog-detail.html">Apple Introduces Search Ads Basic</a>
                                        </h3>
                                        <ul className="meta">
                                            <li><a href="javascript:void(0);"><i className="zmdi zmdi-account col-blue" />Posted
                                                By: John Smith</a></li>
                                ...
                                <div className="card single_post" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                    <div className="body">
                                        <h3 className="m-t-0 m-b-5"><a href="blog-detail.html">WTCR from 2018: new rules, more cars,
                                            more races</a></h3>
                                        <ul className="meta">
                                            <li><a href="javascript:void(0);"><i className="zmdi zmdi-account col-blue" />Posted
                                                By: John Smith</a></li>
                                ...
                                <div className="card single_post" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                    <div className="body">
                                        <h3 className="m-t-0 m-b-5"><a href="blog-detail.html">CSS Timeline Examples from
                                            CodePen</a></h3>
                                        <ul className="meta">
                                            <li><a href="javascript:void(0);"><i className="zmdi zmdi-account col-blue" />Posted
                                                By: John Smith</a></li>
                            ...
                            <div className="col-lg-4 col-md-12 right-box">
                                ...
                                <div className="card" data-aos="fade-left" data-aos-offset={200} data-aos-duration={2000}>
                                    ...
                                    <div className="body widget tag-clouds">
                                        <ul className="list-unstyled m-b-0">
                                            <li><a href="javascript:void(0);" className="tag badge badge-default">Cardio
                                                Monitoring</a></li>
                                            <li><a href="javascript:void(0);" className="tag badge badge-success">Traumatology</a>
                                            </li>
                                            ...
                                            <li><a href="javascript:void(0);" className="tag badge badge-warning">Cardiology</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="card" data-aos="fade-left" data-aos-offset={200} data-aos-duration={2000}>
                                    <div className="header">
                                        <h2><strong>Email</strong> Newsletter <small>Get our products/news earlier than others,
                                            let’s get in touch.</small></h2>
                                    </div>
